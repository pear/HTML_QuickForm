 ...
 * @access public
 */
class HTML_QuickForm_dategroup extends HTML_QuickForm_group
{
    // {{{ properties
    ...
    */
    function HTML_QuickForm_dategroup($elementName = null, $elementLabel = null, $options = array(), $attributes = null)
    {
        $this->HTML_QuickForm_element($elementName, $elementLabel, $attributes);
        $this->_persistantFreeze = true;
        $this->_appendName = true;
        $this->_type = 'dategroup';
